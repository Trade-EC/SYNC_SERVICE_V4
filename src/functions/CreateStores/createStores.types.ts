...
import {
  channelValidator,
  deliveryAdditionalServicesValidator
} from "/opt/nodejs/sync-service-layer/validators/store.validator";
...
export type DeliveryAdditionalService = z.infer<
  typeof deliveryAdditionalServicesValidator
>;

export interface DeliveryServices extends DeliveryAdditionalService {
